...
Ingredient.create(recipe_id: 1, name: "Sweet Masala Wine Cup", amount: 0.50, is_available: true)
...
directions: "1. In a bowl, combine ½ cup tomato, ¼ cup jalapeno, 1 tablespoon of chopped cilantro, ¼ cup red onion, ½ cup avocado, fresh lime juice, salt, and pepper. Stir together and set aside.
